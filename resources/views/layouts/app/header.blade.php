...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:dropdown position="top" align="end">
            ...
            <flux:menu>
                ...
                <flux:menu.radio.group>
                    <flux:menu.item :href="route('settings.profile')" icon="cog" wire:navigate>{{ __('Perfil') }}
                    </flux:menu.item>
                </flux:menu.radio.group>
    ...
    <flux:sidebar stashable sticky
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Libelo')">
                <flux:navlist.item icon="layout-grid" :href="route('dashboard')"
                    :current="request()->routeIs('dashboard')" wire:navigate>
                    {{ __('Painel') }}
                </flux:navlist.item>
            </flux:navlist.group>
            <flux:navlist.group :heading="__('Opções')">
                <flux:navlist.item icon="layout-grid" :href="route('settings')"
